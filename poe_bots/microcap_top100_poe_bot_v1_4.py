#!/usr/bin/env python
# -*- coding: utf-8 -*-
# poe: name=Microcap-Top100-v1.4
# poe: privacy_shield=half
"""Dedicated POE entry for the Top100 microcap v1.4 strategy."""

import microcap_top100_poe_bot as _base

DEDICATED_VERSION = "1.4"
...
def _build_help_text():
    return _original_build_help_text().replace(
        ...
        "说明：本入口固定按 v1.4 运行；v1.0 / v1.6 请使用各自专用 Poe 入口。",
    )
