...
- Run id: `20260521_microcap_top100_v2_0_targetvol_overlay_target_vol`
- Created at: 2026-05-21T18:09:22+08:00
- Project: microcap Top100
- Strategy or version: v2.0
...
- Target entrypoint: `microcap_top100_mom16_biweekly_live_v2_0.py`
- Git branch: `main`
...
- Official v2.0 latest nav date after refresh: `2026-05-20`.
- Fixed parameters: official v2.0 gap buffer, cost model, 60-day realized-vol window, 1.5x max leverage, 10% scale rebalance threshold.
- Best full-sample Sharpe row: `v2_0_tv12`.
- Current default row: `v2_0_tv25`.

## Finalization

- Finalized at: 2026-05-21T18:12:23+08:00
- Decision: recommend_tv12_for_risk_adjusted_selection; keep_tv25_only_if_prioritizing_higher_cagr_with_larger_drawdown; no_source_change
- Stability label: tv10_12_risk_adjusted_stable_high_tv_cap_saturated
