...
OUT_CLOSE_CSV = ROOT / "industry_etf_neutral_ratio_abs5_r2_close.csv"
OUT_NAV_CSV = ROOT / "industry_etf_neutral_ratio_abs5_r2_nav.csv"
OUT_SIGNAL_CSV = ROOT / "industry_etf_neutral_ratio_abs5_r2_latest_signal.csv"
OUT_SUMMARY_JSON = ROOT / "industry_etf_neutral_ratio_abs5_r2_summary.json"
OUT_PNG = ROOT / "industry_etf_neutral_ratio_abs5_r2_curve.png"
OUT_MD = ROOT / "mnt_industry_etf_neutral_ratio_abs5_r2_20260328.md"
...
def load_main_module():
    ...
    spec = importlib.util.spec_from_file_location("mntbot_v61_ratio_abs5_r2", MAIN_SCRIPT)
...
def plot_nav(nav: pd.Series) -> None:
    ...
    plt.plot(nav.index, nav.values, linewidth=1.8, label="Industry ETF Neutral Ratio Abs5 + R2")
    plt.title("Industry ETF Neutral Ratio Abs5 + R2 Strategy NAV")
    plt.legend()
    plt.grid(alpha=0.25)
    plt.tight_layout()
...
def build_summary(
    ...
    return {
        "strategy": "industry_etf_neutral_ratio_abs5_r2",
        "signal_mode": "5d absolute momentum on ETF / 中证500 ratio + R² filter",
