...
# v1.7 intentionally reuses v1.4 internal context/build helpers; recheck this
...
def validate_base_hedge_ratio() -> None:
    ...
    if v1_1_mod is None:
        raise RuntimeError("missing v1_4_mod.v1_1_mod; cannot validate v1.7 base hedge ratio")
    base_mod = getattr(v1_1_mod, "base_mod", None)
    if base_mod is None:
        raise RuntimeError("missing v1_4_mod.v1_1_mod.base_mod; cannot validate v1.7 base hedge ratio")
    checks = {
