...
OUT_GRID = OUTPUT_DIR / "microcap_rsrs_proxy_nm_scan.csv"
OUT_SUMMARY = OUTPUT_DIR / "microcap_rsrs_proxy_nm_summary.json"
OUT_HEATMAP = OUTPUT_DIR / "microcap_rsrs_proxy_nm_heatmap.png"
...
def plot_heatmap(df: pd.DataFrame) -> None:
    ...
    ax.set_title("Wind Microcap Proxy RSRS N-M Scan (Sharpe, threshold +/-0.7)")
